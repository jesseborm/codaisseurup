...
# # Photo
photo1 = Photo.create(remote_image_url: "http://res.cloudinary.com/dcuuut1py/image/upload/c_scale,w_500/v1484823715/sample.jpg")
photo2 = Photo.create(remote_image_url: "http://res.cloudinary.com/dcuuut1py/image/upload/c_scale,w_500/v1495721289/mountains-1210048__340_vtvbyt.jpg")
photo3 = Photo.create(remote_image_url: "http://res.cloudinary.com/dcuuut1py/image/upload/c_scale,w_500/v1495721289/mountains-1210048__340_vtvbyt.jpg")
photo4 = Photo.create(remote_image_url: "http://res.cloudinary.com/dcuuut1py/image/upload/c_scale,w_500/v1495721012/Boring%20Event12.jpg")
...
event3 = Event.create!(
  ...
  user: jesse, categories: [sleek_and_sophisticated, white_washed, a_mans_touch], photos: [photo3])
